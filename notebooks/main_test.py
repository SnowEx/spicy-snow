...
if not skip:
    ...
    ds = download_s1_imgs(search_results, area, tmp_dir = '/Users/zachkeskinen/Documents/spicy-snow/data/tmp', job_name = 'refresh_test_v4', existing_job_name='refresh_test_v4')
